...
urlpatterns += patterns('',
                        ...
                        url(r'^%s' % _('matching_makers/'), app.commands.matching_makers, name='matching_makers'),
                        ...
                        url(r'^admindb/', include(admin.site.urls), name="admin_index1"),
                        ...
                        # politicians 
                        url(r'^%s$' % _('politicians/'), app.readers.politicians, name='politicians'),
                        url(r'^%s(?P<politician>.*)/$' % _('politicians/'), app.readers.politician, name='politician_promises'),
