...
from forum.actions import AskAction, AnswerAction, CommentAction, AcceptAnswerAction, UserJoinsAction, QuestionViewAction, DeleteAction, NodeEditAction
...
def question_status(action,new):
    question = action.node.question
    question.status = question.currentStatusId
    question.save()
    
AcceptAnswerAction.hook(question_status)
AskAction.hook(question_status)
DeleteAction.hook(question_status)
NodeEditAction.hook(question_status)
