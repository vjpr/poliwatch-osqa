var response_commands = {
    ...
    mark_accepted: function(id,status) {
    ...
    unmark_accepted: function(id,status) {
        var $answer = $('#answer-container-' + id);
...
// refreshes the current status shown for the promise after an update has been accepted
function refreshStatus(status) {
	$('#status-box').removeClass();
	$('#status-box').addClass(status);
}